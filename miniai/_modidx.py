...
d = { 'settings': { 'branch': 'master',
  ...
  'syms': { 'miniai.activations': { 'miniai.activations.ActivationStats': ('activations.html#activationstats', 'miniai/activations.py'),
            ...
            'miniai.init': { 'miniai.init.BatchTransformCB': ('initializing.html#batchtransformcb', 'miniai/init.py'),
                             ...
                             'miniai.init.LsuvInitCallback': ('initializing.html#lsuvinitcallback', 'miniai/init.py'),
                             'miniai.init.LsuvInitCallback.__init__': ('initializing.html#lsuvinitcallback.__init__', 'miniai/init.py'),
                             'miniai.init.LsuvInitCallback.before_fit': ('initializing.html#lsuvinitcallback.before_fit', 'miniai/init.py'),
